...
function zy_Countdown(){
	...
	$('#email_login_form .captcha-refresh').click({'form_id':'email_login_form'},refresh_captcha);
	$('#email_login_form .captcha').click({'form_id': 'email_login_form'}, refresh_captcha);
